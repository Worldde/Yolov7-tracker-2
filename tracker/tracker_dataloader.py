...
class TestDataset(Dataset):
    ...
    def _preprocess_yolov7(self, img, ):
        ...
        img_resized = self._letterbox(img, new_shape=self.img_size, stride=self.stride)[0]
...
class DemoDataset(TestDataset):
    ...
    dataset for demo
    """
    def __init__(self, file_name, img_size=[640, 640], model='yolox', stride=32, legacy_yolox=True, **kwargs) -> None:
