...
def get_args():
    ...
    parser.add_argument('--obj', type=str, default='D:/Project/Yolov7-tracker-2/video/A2A_002.mp4', help='video or images folder PATH')
    ...
    """model path"""
    parser.add_argument('--detector_model_path', type=str, default='./weights/best_v4.pt', help='model path')
